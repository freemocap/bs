...
if __name__ == "__main__":
    ...
    output_folder = Path("/home/scholl-lab/ferret_recordings/session_2025-07-11_ferret_757_EyeCamera_P43_E15__1/clips/0_37-1_37/mocap_data/synchronized_videos")


    output_folder.mkdir(exist_ok=True, parents=True)
    videos = get_basler_videos(video_folder)

    clip_videos_basler(videos=videos, output_folder=output_folder, frame_range=(3377, 8754))

    # pupil_folder = Path("/home/scholl-lab/ferret_recordings/session_2025-07-11_ferret_757_EyeCamera_P43_E15__1/full_recording/eye_data/eye_videos")
    # output_folder = Path("/home/scholl-lab/ferret_recordings/session_2025-07-11_ferret_757_EyeCamera_P43_E15__1/clips/clips/0_37-1_37/eye_data/eye_videos")
