...
class SkullAndSpine3DContext(BaseModel):
    entity_path: str = "/"


def required_data_available(recording_folder: RecordingFolder, context: "SkullAndSpine3DContext") -> bool:
...
def plot_ferret_skull_and_spine_3d(
    ...
    if not required_data_available(recording_folder, SkullAndSpine3DContext(entity_path=entity_path)):
        print("Skipping skull and spine 3D: required data not found")
        return
