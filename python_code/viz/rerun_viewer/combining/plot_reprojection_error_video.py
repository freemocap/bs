...
Usage:
    python -m python_code.viz.rerun_viewer.combining.plot_reprojection_error_video <recording_folder>
"""
...
from python_code.viz.rerun_viewer.utils.process_videos import (
    process_video_frames,
    _send_encoded_frames_chunked,
)
from python_code.viz.rerun_viewer.utils.video_data import VideoData
