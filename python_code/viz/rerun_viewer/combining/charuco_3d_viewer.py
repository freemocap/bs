...
from python_code.viz.rerun_viewer.calibration.calibration_recording_folder import CalibrationRecordingFolder
...
def main_rerun_viewer_maker(
    recording_folder: CalibrationRecordingFolder,
    data_3d: np.ndarray,
    landmarks: dict[str, int],
    connections: tuple[tuple[int, int], ...],
    include_side_videos: bool = False,
