...
Usage:
    python -m python_code.viz.rerun_viewer.combining.plot_reprojection_error <recording_folder>
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m python_code.viz.rerun_viewer.combining.plot_reprojection_error <recording_folder>")
        sys.exit(1)
