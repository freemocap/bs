...
from python_code.animal_tracking.multi_video_labeller.helpers.multi_video_processor import (
    MultiVideoProcessor,
)
...
class MultiVideoLabeller(BaseModel):
    ...
    def create(
        ...
        data_handler_config: (
            str | Path
        ) = "python_code/animal_tracking/multi_video_labeller/helpers/face_points.json",
    ):
