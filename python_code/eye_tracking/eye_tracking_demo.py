...
def run_eye_tracking_demo() -> None:
    ...
    # Input data
    input_csv = Path(
        r"D:\bs\ferret_recordings\2025-07-11_ferret_757_EyeCameras_P43_E15__1\clips\0m_37s-1m_37s\eye_data\dlc_output\model_outputs_iteration_11\eye0_clipped_4354_11523DLC_Resnet50_eye_model_v1_shuffle1_snapshot_050.csv"
    )

    # Optional: video file for viewer
    video_path = Path(
        r"D:\bs\ferret_recordings\2025-07-11_ferret_757_EyeCameras_P43_E15__1\clips\0m_37s-1m_37s\eye_data\eye_videos\eye0_clipped_4354_11523.mp4"
    )
    ...
    eye_model = create_default_eye_model(
        eyeball_center_z_mm=20.0,  # Distance from camera to eye
        eyeball_radius_mm=12.0     # Typical eyeball radius
    )
